...
export default function IrrigationRepairFortWorthPage() {
  return (
    <ServicePageLayout
      title="Irrigation Repair in Fort Worth, TX"
    ...
    >
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <p className="text-gray-800 mb-4 text-lg">
          ...
          service all major sprinkler brands used in the Fort Worth area and provide durable, warrantied repairs.
        </p>
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc pl-6 text-gray-800 space-y-2">
            <li><strong>Do you repair any brand?</strong> Yes—we service all major brands used around Fort Worth.</li>
      ...
      <section className="py-16 bg-irrigation-gray mt-16">
        <div className="container-custom">
          <ServiceAreaLocator
            ...
            subtitle="We provide fast, professional irrigation repairs throughout Fort Worth and surrounding communities"
          />
        </div>
      </section>

      <CTA
        title="Need Irrigation Repair in Fort Worth?"

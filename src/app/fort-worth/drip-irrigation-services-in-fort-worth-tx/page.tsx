...
export default function DripIrrigationFortWorthPage() {
  return (
    <ServicePageLayout
      title="Drip Irrigation in Fort Worth, TX"
    ...
    >
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <p className="text-gray-800 mb-4 text-lg">
          ...
          Our licensed team designs, installs, and maintains drip systems tailored to Fort Worth landscapes, native plants, and soil conditions.
        </p>
        ...
        <h3 className="text-xl font-bold text-irrigation-darkBlue mb-3">Our Fort Worth Drip Installation Process</h3>
      ...
      <section className="py-16 bg-irrigation-gray mt-16">
        <div className="container-custom">
          <ServiceAreaLocator
            ...
            subtitle="Texas Best Sprinklers provides expert drip irrigation services throughout Fort Worth"
          />
        </div>
      </section>

...
export default function SprinklerRepairFortWorthPage() {
  return (
    <ServicePageLayout
      title="Sprinkler Repair in Fort Worth, TX"
      ...
      features={['Broken head and nozzle replacements', 'Zone and valve troubleshooting', 'Controller and sensor repairs', 'Coverage optimization and tuning']}
      ...
      <section className="py-16 bg-irrigation-gray mt-16">
        <div className="container-custom">
          <ServiceAreaLocator
            ...
            subtitle="Expert sprinkler repairs available across Fort Worth and surrounding communities"
          />
        </div>
      </section>

...
export default function SprinklerInstallationFortWorthPage() {
  return (
    <ServicePageLayout
      title="Sprinkler Installation in Fort Worth, TX"
    ...
    >
      ...
      <section className="py-16 bg-irrigation-gray mt-16">
        <div className="container-custom">
          <ServiceAreaLocator
            ...
            subtitle="We design and install high-efficiency sprinkler systems across Fort Worth"
          />
        </div>
      </section>
      ...
      <CTA
        ...
        subtitle="Request a free on-site evaluation and custom design for your Fort Worth property."

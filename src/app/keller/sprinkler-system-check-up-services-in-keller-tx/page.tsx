...
export const metadata = {
  ...
  description: 'Comprehensive sprinkler inspections and tune-ups in Keller, TX. Optimize coverage, fix leaks, and save water.',
};

export default function SprinklerCheckupKellerPage() {
  return (
    <ServicePageLayout
      title="Sprinkler System Check-Up in Keller, TX"
    ...
    >
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <p className="text-gray-800 mb-4 text-lg">
          Our Keller check-up verifies coverage, pressure, and component condition—catching small issues before they turn into
      ...
      <div className="bg-white rounded-lg shadow-md p-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <ul className="list-disc pl-6 text-gray-800 space-y-2">
              <li><strong>How often should I get a check-up?</strong> Most Keller homes benefit from a spring and fall visit.</li>
      ...
      <section className="py-16 bg-irrigation-gray mt-16">
        <div className="container-custom">
          <ServiceAreaLocator
            ...
            subtitle="Seasonal check-ups and tune-ups available throughout the Fort Worth area"
          />
        </div>
      </section>

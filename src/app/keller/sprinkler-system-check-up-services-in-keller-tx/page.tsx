...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Comprehensive sprinkler system check-ups in Keller, TX. Seasonal tune-ups, controller optimization, coverage adjustments, and leak prevention.",
  path: '/keller/sprinkler-system-check-up-services-in-keller-tx',
  image: 'sprinkler',
});

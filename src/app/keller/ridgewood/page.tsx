...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Sprinkler repair, irrigation tune-ups, and drainage planning for Ridgewood homes in Keller, TX. Licensed local service. Call (817) 304-7896.",
  path: '/keller/ridgewood',
  image: 'sprinkler',
});

...
export const blogPosts = [
  {
    ...
    image: "https://ik.imagekit.io/6j5o4uwvz/TexasBest_webp/long-shot-of-fort-worth-drainage.webp?updatedAt=1763144537900",
    date: "June 12, 2023",
  ...
  },
  {
    ...
    excerpt: "Learn how modern irrigation technology can slash your water usage while keeping your landscape vibrant and healthy.",
  ...
  },
  {
    ...
    excerpt: "Navigate the different types of sprinkler heads and learn which ones are ideal for specific areas of your yard.",
    content: "Selecting the right sprinkler heads is essential for efficient irrigation and healthy plants. Spray heads deliver a fan-shaped spray pattern and are ideal for small to medium turf areas with relatively flat terrain. Rotor heads rotate streams of water across the landscape and work well for larger areas, typically covering 20-150 feet. Impact rotors create a distinctive tapping sound and are highly durable, making them suitable for sports fields and large properties. Drip emitters deliver water directly to plant roots and are perfect for gardens, flower beds, and container plants. Multi-stream rotational nozzles combine the benefits of spray and rotor heads, providing excellent distribution uniformity while reducing runoff and wind drift.",

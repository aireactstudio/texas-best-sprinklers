...
const westlakeData: ServiceContent = {
  title: 'Professional Sprinkler Maintenance in Westlake, Texas',
  metaDescription: 'Expert sprinkler system maintenance services in Westlake. Keep your irrigation system running efficiently with seasonal tune-ups, repairs, and winterization.',

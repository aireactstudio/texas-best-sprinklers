...
//   // 'euless': {
//   //   title: 'Professional Irrigation Repair in Euless, Texas',
//   // 'hurst': {
//   //   title: 'Professional Irrigation Repair in Hurst, Texas',
//   // 'mansfield': {
//   //   title: 'Professional Irrigation Repair in Mansfield, Texas',
//   // 'grand-prairie': {
//   //   title: 'Professional Irrigation Repair in Grand Prairie, Texas',
//   // 'haltom-city': {
//   //   title: 'Professional Irrigation Repair in Haltom City, Texas',
//   // 'watauga': {
//   //   title: 'Professional Irrigation Repair in Watauga', Texas',
//   // 'benbrook': {
//   //   title: 'Professional Irrigation Repair in Benbrook', Texas',
//   // 'flower-mound': {
//   //   title: 'Professional Irrigation Repair in Flower Mound', Texas',
//   // 'lewisville': {
//   //   title: 'Professional Irrigation Repair in Lewisville', Texas',
//   // 'coppell': {
//   //   title: 'Professional Irrigation Repair in Coppell', Texas',
//   // 'irving': {
//   //   title: 'Professional Irrigation Repair in Irving', Texas',
//   // 'trophy-club': {
//   //   title: 'Professional Irrigation Repair in Trophy Club', Texas',
//   // 'roanoke': {
//   //   title: 'Professional Irrigation Repair in Roanoke', Texas',
//   // 'westlake': {
//   //   title: 'Professional Irrigation Repair in Westlake', Texas',
//   // 'annetta': {
//   //   title: 'Professional Irrigation Repair in Annetta', Texas',
//   // 'brock': {
//   //   title: 'Professional Irrigation Repair in Brock', Texas',
//   // 'millsap': {
//   //   title: 'Professional Irrigation Repair in Millsap', Texas',
//   // 'peaster': {
//   //   title: 'Professional Irrigation Repair in Peaster', Texas',
//   // 'hudson-oaks': {
//   //   title: 'Professional Irrigation Repair in Hudson Oaks', Texas',
//   // 'aledo': {
//   //   title: 'Professional Irrigation Repair in Aledo', Texas',
//   // 'willow-park': {
//   //   title: 'Professional Irrigation Repair in Willow Park', Texas',
//   // 'springtown': {
//   //   title: 'Professional Irrigation Repair in Springtown', Texas',
//   // 'cool': {
//   //   title: 'Professional Irrigation Repair in Cool', Texas',
...
//     faqs: [
//       {
//         question: 'How quickly can you repair my irrigation system in Weatherford?',
//         answer: 'We typically respond to Weatherford repair requests within 24-48 hours. For emergency repairs involving major leaks or water loss, we offer same-day service when available. Most repairs can be completed in a single visit.'
//       },
//       {
...
//       },
//       {
//         question: 'What is your service call fee in Weatherford?',
//         answer: 'Our standard service call fee for Weatherford is $95, which includes system diagnostics and up to 30 minutes of labor. If additional repairs are needed', we provide a detailed estimate before proceeding with any work.'
//       },
//       {
...
//   }',
//   'azle': {
//     title: 'Professional Irrigation Repair in Azle', Texas',
//     metaDescription: 'Expert sprinkler system repair services in Azle. Fix leaks, broken heads, controller issues', and more with our prompt', professional irrigation repair service.',
//     heroImage: '/assets/images/optimized/Irrigation-Repair.png',
//     serviceType: ServiceType.IRRIGATION_REPAIR,
//     intro: "Texas Best Sprinklers provides Azle homeowners with reliable irrigation repair services to quickly identify and fix problems with your sprinkler system. Our experienced technicians can diagnose and repair any issue, from simple sprinkler head replacements to complex valve and controller repairs near Eagle Mountain Lake."',
//     benefits: [
//       {
//         title: 'Fast Response Time',
//         description: 'We typically respond to repair requests within 24-48 hours to minimize water waste and landscape damage.',
...
//           'Electronic leak detection',
//           'Pipe repair and replacement',
//           'Fitting and connector fixes',
//           'Valve box leak repairs',
//           'Pressure regulation'
//         ]
//       },
//       {
//         title: 'Controller & Valve Repairs',
//         description: 'We diagnose and fix issues with irrigation controllers, valves', and wiring to ensure your system operates on schedule and with proper zone control.',
//         image: 'https://imagedelivery.net/Hs1aBZ5UERW4OpkuLtKJ6A/7ae3f27e-87ce-4d6d-c566-eb9de45f0000/public',
//         features: [
//           'Controller programming & repair',
...
//         description: 'Our technician will visit your Azle property to perform a thorough inspection and diagnose the root cause of your irrigation problems.'
//       },
//       {
//         step: 3',
...
//         description: 'We test all repaired components and run the system through a complete cycle to verify proper operation before we leave.'
//       }
//     ],
//     faqs: [
//       {
//         question: 'How quickly can you repair my irrigation system in Azle?',
//         answer: 'We typically respond to Azle repair requests within 24-48 hours. For emergency repairs involving major leaks or water loss', we offer same-day service when available. Most repairs can be completed in a single visit.'
//       },
//       {
//         question: 'What are the most common irrigation system problems in Azle?',
//         answer: 'Common problems in the Azle area include clogged or broken sprinkler heads due to the region\'s soil conditions, valve malfunctions, controller issues often caused by power fluctuations', and pipe leaks sometimes resulting from soil movement during seasonal changes.'
//       },
//       {
//         question: 'Do you offer any warranties on irrigation repairs?',
//         answer: 'Yes, all our repair work is covered by a 30-day warranty on labor and we honor manufacturers\' warranties on all parts used. For complete system overhauls', we offer extended warranty options.'
//       },
//       {
//         question: 'Will you help me program my irrigation controller after repairs?',
//         answer: 'Absolutely! We\'ll program your controller with an efficient watering schedule based on your landscape needs, local water restrictions', and weather patterns typical in the Azle area.'
//       },
//       {
//         question: 'How can I prepare for my irrigation repair appointment?',
//         answer: 'To help us diagnose issues efficiently, please note specific problem areas in your yard, the approximate location of valves if known, have your controller accessible', and ensure water can be turned on to the system during our visit.'
//       }
//     ],
//     testimonial: {
//       quote: "Our sprinkler system was having intermittent issues that other companies couldn't fix. Texas Best Sprinklers quickly identified the problem and had everything working perfectly again. Great service from a local company that understands Azle's specific conditions.",
...
//   }',
//   'mineral-wells': {
//     title: 'Professional Irrigation Repair in Mineral Wells', Texas',
//     metaDescription: 'Expert sprinkler system repair services in Mineral Wells. Fix leaks, broken heads, controller issues', and more with our prompt', professional irrigation repair service.',
//     heroImage: '/assets/images/optimized/Irrigation-Repair.png',
//     serviceType: ServiceType.IRRIGATION_REPAIR,
//     intro: "Texas Best Sprinklers provides Mineral Wells homeowners with reliable irrigation repair services to quickly identify and fix problems with your sprinkler system. Our experienced technicians can diagnose and repair any issue, from simple sprinkler head replacements to complex valve and controller repairs."',
//     benefits: [
//       {
//         title: 'Fast Response Time',
//         description: 'We typically respond to repair requests within 24-48 hours to minimize water waste and landscape damage.',
...
//         step: 2',
//         title: 'On-Site Diagnosis',
//         description: 'Our technician will visit your Mineral Wells property to perform a thorough inspection and diagnose the root cause of your irrigation problems.'
//       },
//       {
//         step: 3',
//         title: 'Repair Recommendation',
...
//     faqs: [
//       {
//         question: 'How quickly can you repair my irrigation system in Mineral Wells?',
//         answer: 'We typically respond to Mineral Wells repair requests within 24-48 hours. For emergency repairs involving major leaks or water loss', we offer same-day service when available. Most repairs can be completed in a single visit.'
//       },
//       {
//         question: 'What are the most common irrigation system problems in Mineral Wells?',
//         answer: 'Common problems in the Mineral Wells area include clogged or broken sprinkler heads due to the region\'s mineral-rich soil conditions, valve malfunctions, controller issues often caused by power fluctuations', and pipe leaks sometimes resulting from soil movement during seasonal changes.'
//       },
//       {
//         question: 'Do you offer any warranties on irrigation repairs?',
//         answer: 'Yes, all our repair work is covered by a 30-day warranty on labor and we honor manufacturers\' warranties on all parts used. For complete system overhauls', we offer extended warranty options.'
...
//       {
//         question: 'Will you help me program my irrigation controller after repairs?',
//         answer: 'Absolutely! We\'ll program your controller with an efficient watering schedule based on your landscape needs, local water restrictions', and weather patterns typical in the Mineral Wells area.'
//       },
//       {
//         question: 'How can I prepare for my irrigation repair appointment?',
//         answer: 'To help us diagnose issues efficiently, please note specific problem areas in your yard, the approximate location of valves if known, have your controller accessible', and ensure water can be turned on to the system during our visit.'
...
//     ],
//     testimonial: {
//       quote: "After struggling with inconsistent coverage and high water bills', I called Texas Best Sprinklers. They found several issues previous companies had missed and fixed everything in one visit. My system now works perfectly and I'm saving money on my water bill.",
//       author: "Richard W.",

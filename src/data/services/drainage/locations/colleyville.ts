...
export const colleyvilleData: ServiceContent = {
  title: 'Professional Drainage Solutions in Colleyville, TX',
  ...
  heroImage: '/assets/images/drainage-colleyville.jpg',
  ...
  faqs: getCommonFAQs('Colleyville'),
  testimonial: {

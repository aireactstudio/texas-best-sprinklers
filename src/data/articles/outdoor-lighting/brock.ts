...
const brockArticleData: LightingArticleData = {
  location: 'Brock',
  introduction: "Enhance your Brock property with professional landscape lighting designed to accentuate architectural features, improve security, and extend your outdoor living enjoyment. Brock's rural charm and growing communities feature a mix of traditional ranch properties, custom homes, and newer developments that benefit from tailored lighting approaches. Texas Best Sprinklers specializes in creating thoughtful lighting systems that showcase your property's unique characteristics while providing functional illumination for evening activities and enhanced security. Our durable, energy-efficient solutions are specifically engineered for North Texas weather conditions and professionally installed to deliver years of reliable performance across Brock's residential landscapes.",
  
  lightingTypes: [
    {
      title: 'Architectural Accent Lighting',
      content: "Highlight your Brock home's distinctive features with precision-placed uplighting and spotlighting. Our architectural lighting solutions emphasize stone facades, dramatic entries, unique textures, and architectural details that define your home's character.",
      benefits: [
    ...
    },
    {
      ...
      content: "Ensure safe navigation throughout your Brock property with elegant fixtures that illuminate walkways, garden paths, and steps. Our path lighting combines safety with aesthetic appeal, using quality fixtures positioned to create balanced illumination patterns.",
      benefits: [
        ...
        'Available in multiple styles to complement Brock\'s homes',
    ...
    },
    {
      ...
      content: "Enhance your lifestyle with thoughtful lighting for outdoor living spaces, including patios, pool surrounds, and outdoor kitchens. Our entertainment area lighting creates inviting environments for evening gatherings throughout Brock's active outdoor living season.",
      benefits: [
    ...
    },
    {
      ...
      content: "Protect your Brock property with effective security lighting that enhances safety while maintaining aesthetic appeal. Our security-focused designs eliminate vulnerable dark areas without creating harsh floodlight effects that detract from your property's beauty.",
      benefits: [
  ...
  applicationAreas: [
    {
      ...
      icon: 'home',
      content: "Brock's spacious ranch properties benefit from strategic lighting that defines boundaries, highlights architectural features, and enhances security across expansive outdoor areas."
    },
    {
      title: 'Custom Home Developments',
      icon: 'tool',
      content: "Brock's growing communities feature custom-built homes that benefit from lighting that emphasizes unique architectural details, premium materials, and distinctive design elements."
    },
    {
      title: 'Traditional Texas Architecture',
      icon: 'layout',
      content: "Many Brock properties feature traditional Texas designs that transform beautifully with lighting designed to accentuate classic architectural elements and natural stone features."
    },
    {
    ...
    },
    {
      ...
      icon: 'sun',
      content: "Brock homes often feature extensive outdoor living areas that benefit from layered lighting approaches creating distinct zones while maintaining consistent aesthetic character."
    }
  ],
  ...
  installationProcess: [
    {
      ...
      content: "We begin with an in-depth discussion of your Brock property's unique characteristics, your aesthetic preferences, and how you use your outdoor spaces. This consultation includes a thorough assessment of architectural features, landscape elements, and existing electrical infrastructure."
    },
    {
      title: 'Custom Lighting Plan Development',
      content: "Based on our consultation, we create a detailed lighting design specifically for your Brock property, identifying key elements to highlight, optimal fixture placement, and technical specifications. This customized plan addresses both aesthetic goals and practical considerations."
    },
    {
  ...
  benefits: [
    {
      ...
      icon: 'trending-up',
      content: "Professional landscape lighting significantly increases your Brock home's curb appeal and perceived value. In today's real estate market, quality exterior lighting is increasingly viewed as an expected feature of premium properties.",
      stat: '15-20%',
    ...
    },
    {
      ...
      icon: 'sun',
      content: "Brock's favorable climate allows for extensive outdoor living, and proper lighting extends your usable hours long after sunset. This effectively expands your living space and enhances your enjoyment of outdoor environments throughout the evening.",
      stat: '4-6 hrs',
    ...
    },
    {
      ...
      icon: 'users',
      content: "Beautiful lighting contributes to Brock's reputation for exceptional residential environments, enhancing neighborhood aesthetics while creating inviting settings for evening activities, casual interaction, and outdoor entertainment.",
      stat: '85%',
  ...
  maintenanceTips: [
    {
      ...
      content: "As plants grow and seasons change, periodically adjust lighting fixtures to maintain optimal illumination patterns. This is particularly important in Brock's robust growing season when landscape development can quickly alter lighting effects."
    },
    {
      title: 'Regular Fixture Cleaning',
      content: "Clean fixture lenses quarterly to remove dust, pollen, and debris that accumulate in Brock's rural environment. This simple maintenance step preserves fixture appearance and maintains maximum illumination quality."
    },
    {

...
const coolArticleData: IrrigationRepairArticleData = {
  ...
  diagnosticProcess: [
    ...
    },
    {
      ...
      content: "We examine your controller programming, wiring connections, and sensor integration to ensure everything is functioning correctly and optimized for Cool's climate conditions and water conservation needs."
    },
    {

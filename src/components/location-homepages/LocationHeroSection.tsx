...
export default function LocationHeroSection({
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 pt-32 pb-4 lg:pt-32 lg:pb-8 relative z-10">
      <div className="container mx-auto px-4 pt-28 pb-4 lg:pt-36 lg:pb-8 relative z-10">
